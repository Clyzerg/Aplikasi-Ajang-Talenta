    ...
    <style>
        ...
        * {
        ...
        h2 {
            margin-bottom: 20px;
            font-size: 24px;
            color: #66ccff; /* Slightly darker blue */
            font-weight: 600;
            animation: slideUp 1s ease-out;
        }
...
<body>
    <div class="login-container">
        <h1>Selamat Datang di Aplikasi Pendaftaran Ajang Talenta</h1> <!-- Welcome Header -->
        ...
        <h2>Login</h2> <!-- Login Subtitle -->

        <form action="<?php echo site_url('auth/auth_process_siswa'); ?>" method="post">
